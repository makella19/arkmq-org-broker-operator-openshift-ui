 ...
 * Connectivity test button is a placeholder pending cert-manager integration.
 */
      ...
      <Stack hasGutter>
        ...
        <StackItem>
          <Button
            ...
            data-test="broker-app-run-connectivity-test"
          >
        ...
        {connectivityTested && (
          <StackItem>
            <Alert
              variant="info"
              isInline
              title={t('Connectivity testing coming soon')}
              data-test="broker-app-connectivity-result"
            >
              {t(
                'Connectivity testing will be available once the full data plane integration is complete.',
              )}
            </Alert>
          </StackItem>
        )}
